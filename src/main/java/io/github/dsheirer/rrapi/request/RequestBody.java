...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = GetRadioSystemBySystemId.class, name = "getTrsBySysid"),
    @JsonSubTypes.Type(value = GetRadioSystemDetails.class, name = "getTrsDetails"),
    @JsonSubTypes.Type(value = GetRadioSystemSites.class, name = "getTrsSites"),
    @JsonSubTypes.Type(value = GetRadioSystemFlavor.class, name = "getTrsFlavor"),
    @JsonSubTypes.Type(value = GetRadioSystemTalkgroupCategories.class, name = "getTrsTalkgroupCats"),
    @JsonSubTypes.Type(value = GetRadioSystemTalkgroups.class, name = "getTrsTalkgroups"),
    @JsonSubTypes.Type(value = GetRadioSystemType.class, name = "getTrsType"),
    @JsonSubTypes.Type(value = GetRadioSystemVoice.class, name = "getTrsVoice"),
